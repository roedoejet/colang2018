...
var WordModal = /** @class */ (function () {
    ...
    WordModal = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'word-modal',template:/*ion-inline-start:"C:\Users\pinea\colang-mtd-template\src\components\word-modal\word-modal.component.html"*/'<ion-header>\n\n  <ion-toolbar>\n\n    <ion-buttons left>\n\n      <button ion-button (click)="dismiss()">\n\n        <ion-icon name="arrow-back"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>\n\n      Word Info\n\n    </ion-title>\n\n  </ion-toolbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-card>\n\n    <div *ngIf="displayImages">\n\n      <img (click)="playAudio(entry)" [(src)]="image" onError="this.src=\'assets/img/default.png\'" *ngIf="entry.img" />\n\n    </div>\n\n    <ion-card-content>\n\n      <ion-card-title>\n\n        {{entry.word}}\n\n      </ion-card-title>\n\n      <p class="definition">\n\n        {{entry.definition}}\n\n      </p>\n\n\n\n    </ion-card-content>\n\n\n\n  </ion-card>\n\n</ion-content>'/*ion-inline-end:"C:\Users\pinea\colang-mtd-template\src\components\word-modal\word-modal.component.html"*/
        }),
...
var MTD = /** @class */ (function () {
    ...
    MTD = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\pinea\colang-mtd-template\src\app\app.html"*/'<!--<ion-split-pane [when]="isiPad">-->\n\n  <ion-menu [content]="content">\n\n    <ion-header>\n\n      <ion-toolbar>\n\n        <ion-title>Menu</ion-title>\n\n      </ion-toolbar>\n\n    </ion-header>\n\n\n\n    <ion-content scrollbar-y-auto on-swipe-right="menuOpen">\n\n      <ion-list>\n\n        <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n        {{p.title}}\n\n      </button>\n\n      </ion-list>\n\n    </ion-content>\n\n\n\n  </ion-menu>\n\n\n\n  <!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n  <ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n\n<!--</ion-split-pane>-->'/*ion-inline-end:"C:\Users\pinea\colang-mtd-template\src\app\app.html"*/
        }),
...
var About = /** @class */ (function () {
    ...
    About = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Users\pinea\colang-mtd-template\src\pages\about\about.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>About</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding scrollbar-y-auto>\n\n  <div>\n\n    <p>\n\n      Some basic information about the project.\n\n    </p>\n\n\n\n\n\n  </div>\n\n</ion-content>'/*ion-inline-end:"C:\Users\pinea\colang-mtd-template\src\pages\about\about.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
    ], About);
    return About;
...
var Browse = /** @class */ (function () {
    function Browse(navCtrl, mtdService) {
        ...
        this.increment = 7;
        this.currentIncr = this.getX(window['dataDict']["words"].data, 0);
